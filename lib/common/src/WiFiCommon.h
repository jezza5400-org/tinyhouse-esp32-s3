...
constexpr const char *isrgRootX1 = R"EOF(
-----BEGIN CERTIFICATE-----
...
public:
	 ...
	 * @param payload
	 *         JSON document that will be converted into dweet bracket-notation query parameters.
	 ...
	 * @param payload
	 *         Query string appended to the dweet URL.
	 * @return true when request write complete successfully.
	 */
...
private:
	...
	bool sendQueryString(const String &queryString);
};
